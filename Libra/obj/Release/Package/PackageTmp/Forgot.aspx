<%@ Page Title="Lembrar senha" Language="C#" MasterPageFile="~/SiteAccount.Master" AutoEventWireup="true" CodeBehind="Forgot.aspx.cs" Inherits="Libra.ForgotPassword" Async="true" %>
        ...
        <div class="x_panel" id="login">
            ...
            <asp:PlaceHolder runat="server" ID="DisplayEmail" Visible="false">
                <div class="x_content">
                    ...
                    <div class="form-group">
                        <a runat="server" href="~/Login" title="Ok!" class="btn btn-default">Ok!</a>
                    </div>
                </div>
            </asp:PlaceHolder>
        </div>
