...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div>
            <asp:TextBox ID="txtCorProduto" runat="server" CssClass="form-control text-uppercase" MaxLength="100"></asp:TextBox>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div>
            <asp:CheckBox runat="server" ID="chkCorProdutoAtivo" Checked="true" />
        </div>
    </div>
</div>
<div class="row">&nbsp;</div>
